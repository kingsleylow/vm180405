...
if($this->product_type ==1001){//checks if product is downloadable
    if($this->fxpaymentmethod == 1){//if payment method is stripe card 
        ...
        if(!class_exists('FxbotmarketProduct')) {
          include_once JPATH_ROOT.'/components/com_fxbotmarket/helpers/product.php';
                ...
                echo JRoute::_ ('index.php?option=com_fxbotmarket&task=paystripe.paybitcoindownloadable&orderid='.(int)$this->fxbotmarket_id_downloadable_order);?>" method="POST">
