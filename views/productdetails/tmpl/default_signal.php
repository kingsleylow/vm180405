...
<h2></h2>
    ...
    <?php // Product Title   ?>
    <h1 itemprop="name" class="fxbproductname" style="float:none;"><?php echo $this->product->product_name ?></h1>
    ...
    $results = array( '{quicksell file="com_quicksell.zip" price="20" title="buy with form" currency="" customPayPal="" emailDelivery="" requireRegistration="" discount_rate="" return_url="" notification_email="" rm="" cbt="" sub="" addToCart="" partner_id="" license_id="" freeForGroup="" assignUserToGroup="" subscriptionEnable="" subscriptionRate="" subscriptionBillingCycle="1" subscriptionBillingCycleUnit="M" subscriptionRecurringPayments="" subscriptionRecurringTimes="" cbpl=""}css_buttons/bootstrapprimary{/quicksell}',
    'file="FXBOT.MARKET_Operations.pdf"',
    'FXBOT.MARKET_Operations.pdf',
    'price="20"',
     20,
     'title="buy with form"',
    'buy with form',
   ...
   '',
    ...
    1,
     'subscriptionBillingCycleUnit="M"',
    'M',
      'subscriptionRecurringPayments=""',
     '',
     'subscriptionRecurringTimes=""',
    '',
      'cbpl=""',
    '',
    'css_buttons/bootstrapprimary'
);
    //echo $this->makeButton($results);
...
?>
	...
	<div class="vm-product-details-container">
		...
		echo shopFunctionsF::renderVmSubLayout('prices_signal',array('product'=>$this->product,'currency'=>$this->currency));
		?> <div class="clear"></div><?php
		echo shopFunctionsF::renderVmSubLayout('addtocart_signal',array('product'=>$this->product));
    ...
    <ul class="nav nav-pills cust-detail-tabs">
...
if (!empty($this->product->product_desc) || true) {
	...
	<div id="desc" class="tab-pane fade in active">
		<div class="customer-reviews">
			<h4><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></h4>
